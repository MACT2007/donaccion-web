    ...
    <div className="flex min-h-[70vh] items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          La página que buscas no existe o fue movida. Puedes volver al inicio y seguir explorando campañas.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DonAcción — Donaciones con transparencia" },
      {
        name: "description",
        content:
          "DonAcción conecta donantes con campañas verificadas de ropa, alimentos, salud, educación y más, con metas y rendición de cuentas públicas.",
      },
      { name: "author", content: "DonAcción" },
      { property: "og:site_name", content: "DonAcción" },
